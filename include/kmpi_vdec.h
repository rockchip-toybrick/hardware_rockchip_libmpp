...
rk_s32 kmpp_vdec_chan_init(KmppChanId *ctx, KmppVdecInitCfg cfg);
rk_s32 kmpp_vdec_chan_deinit(KmppChanId ctx, KmppVdecDeinitCfg cfg);
...
rk_s32 kmpp_vdec_chan_reset(KmppChanId ctx, KmppVdecResetCfg cfg);
rk_s32 kmpp_vdec_chan_start(KmppChanId ctx, KmppVdecStartCfg cfg);
rk_s32 kmpp_vdec_chan_stop(KmppChanId ctx, KmppVdecStopCfg cfg);
rk_s32 kmpp_vdec_chan_ctrl(KmppChanId ctx, rk_s32 cmd, void *arg);

/* static config */
rk_s32 kmpp_vdec_get_cfg(KmppCtx ctx, KmppVdecStCfg cfg);
rk_s32 kmpp_vdec_set_cfg(KmppCtx ctx, KmppVdecStCfg cfg);
rk_s32 kmpp_vdec_chan_get_cfg(KmppChanId ctx, KmppVdecStCfg cfg);
rk_s32 kmpp_vdec_chan_set_cfg(KmppChanId ctx, KmppVdecStCfg cfg);

/* runtime config */
rk_s32 kmpp_vdec_get_rt_cfg(KmppCtx ctx, KmppVdecRtCfg cfg);
rk_s32 kmpp_vdec_set_rt_cfg(KmppCtx ctx, KmppVdecRtCfg cfg);
rk_s32 kmpp_vdec_chan_get_rt_cfg(KmppChanId ctx, KmppVdecRtCfg cfg);
rk_s32 kmpp_vdec_chan_set_rt_cfg(KmppChanId ctx, KmppVdecRtCfg cfg);
...
rk_s32 kmpp_vdec_chan_decode(KmppChanId ctx, KmppPacket pkt, KmppFrame *frm);
rk_s32 kmpp_vdec_chan_put_pkt(KmppChanId ctx, KmppPacket pkt);
rk_s32 kmpp_vdec_chan_get_frm(KmppChanId ctx, KmppFrame *frm);
