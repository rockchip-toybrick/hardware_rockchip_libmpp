...
#define ENTRY_TABLE(ENTRY)                                                                                                                                          \
    ...
    ENTRY(rc,   mt_st_swth_frm_qp,  S32, RK_S32,        MPP_ENC_RC_CFG_CHANGE_FM_LV_QP,         rc, mt_st_swth_frm_qp)                                              \
    /* prep config */                                                                                                                                               \
    ...
    ENTRY(hw,   flt_str_i,      S32, RK_S32,            MPP_ENC_HW_CFG_CHANGE_FLT_STR_I,        hw, flt_str_i)                                                      \
    ...
    ENTRY(tune, atf_str,        S32, RK_S32,            MPP_ENC_TUNE_CFG_CHANGE_ATF_STR,        tune, atf_str)
