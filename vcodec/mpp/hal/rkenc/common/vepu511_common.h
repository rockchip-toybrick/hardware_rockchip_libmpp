...
#define VEPU511_FRAME_OFFSET        (156 * sizeof(RK_U32)) /* 0x00000270 reg156 - 0x000003fc reg255 */
#define VEPU511_RC_ROI_OFFSET       (1024 * sizeof(RK_U32)) /* 0x00001000 reg1024 - 0x0000113c reg1103 */
...
#define VEPU511_SCL_JPGTBL_OFFSET   (2176 * sizeof(RK_U32)) /* 0x00002200 reg2176 - 0x0000270c reg2499 */
#define VEPU511_OSD_OFFSET          (3072 * sizeof(RK_U32)) /* 0x00003000 reg3072 - 0x00003134 reg3149 */
...
typedef struct Vepu511JpegFrame_t {
	/* 0x00000400 reg256 */
	RK_U32 adr_bsbt;
